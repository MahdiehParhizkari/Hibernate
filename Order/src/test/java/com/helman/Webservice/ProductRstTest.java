...
public class ProductRstTest {
    ...
    public void insert() throws JsonProcessingException {
        ...
        Response response = invocationBuilder.header(HttpHeaders.AUTHORIZATION, token).post(Entity.json(productJson));
        System.out.println(response.getStatus() +"->"+ response.getStatusInfo());
    ...
    public void update() throws JsonProcessingException {
        ...
        ObjectMapper mapper = new ObjectMapper();
        String productJson = mapper.writer(filterProvider).withDefaultPrettyPrinter().writeValueAsString(product);
        Response response = invocationBuilder.header(HttpHeaders.AUTHORIZATION, token).put(Entity.json(productJson));
        System.out.println(response.getStatus() +"->"+ response.getStatusInfo());
        System.out.println(response.readEntity(String.class));
    }
